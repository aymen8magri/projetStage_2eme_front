...
export class AppComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    const tokenExists = !!localStorage.getItem('token'); // Simplified token check
    if (tokenExists) {
      this.getMenu(); // Update the menu when token is set
  ...
  getMenu() {
    this.menu = menu; // Your logic to update the menu dynamically
